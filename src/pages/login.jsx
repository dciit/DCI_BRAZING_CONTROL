    ...
    const handleSubmit = (event) => {
        ...
        if (req == 0) {
            try {
                ...
                setUseReq(false);
                setPwdReq(false);
                axios.get('http://websrv01.dci.daikin.co.jp/BudgetCharts/BudgetRestService/api/authen?username=' + data.get('email') + '&password=' + encodeURIComponent(pwd)).then(async (res) => {
